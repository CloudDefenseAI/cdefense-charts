...
This file documents all notable changes to Cdefensesidekick Helm Chart. The release
numbering uses [semantic versioning](http://semver.org).

Before release 0.1.20, the helm chart can be found in `cdefensesidekick` [repository](https://github.com/cdefensesecurity/cdefensesidekick/tree/master/deploy/helm/cdefensesidekick).

## 0.5.16

* Add `affinity`, `nodeSelector` and `tolerations` values for the Cdefensesidekick test-connection pod
...
* Fix Prometheus extralabels configuration in Cdefensesidekick

## 0.5.13

* Fix missing quotes in Cdefensesidekick-UI ttl argument

## 0.5.12

* Fix missing space in Cdefensesidekick-UI ttl argument

## 0.5.11

* Fix missing space in Cdefensesidekick-UI arguments

## 0.5.10

* upgrade Cdefensesidekick image to 2.27.0
* upgrade Cdefensesidekick-UI image to 2.1.0
...
* Add `webui.ttl` to set TTL of keys in Cdefensesidekick-UI
* Add `webui.loglevel` to set log level in Cdefensesidekick-UI
* Add `webui.user` to set log user:password in Cdefensesidekick-UI
...
* Support full configuration of `securityContext` blocks in cdefensesidekick and cdefensesidekick-ui deployments, and redis statefulset.

## 0.5.2

* Update Cdefensesidekick-UI image (fix wrong redirect to localhost when an ingress is used)

## 0.5.1

* Support `ingressClassName` field in cdefensesidekick ingresses.
...
* Upgrade Cdefensesidekick-UI to v2.0.1
...
* Enable extra volumes and volumemounts for `cdefensesidekick` via values
...
* Make image registries for `cdefensesidekick` and `cdefensesidekick-ui` configurable
...
* Add missing `imagePullSecrets` in `cdefensesidekick/templates/deployment-ui.yaml`
...
* Fix link to Cdefense in the `README.md`

## 0.3.4

### Major Changes

* Bump up version (`v1.0.1`) of image for `cdefensesidekick-ui`
...
* Updated cdefensesidekuck-ui default image version to `v0.2.0`
...
* Fix cdefensesidekick configuration table to use full path of configuration properties in the `README.md`
...
* `Cdefensesidekick` and its chart are now part of `cdefensesecurity` organization
...
* Initial release of Cdefensesidekick Helm Chart
